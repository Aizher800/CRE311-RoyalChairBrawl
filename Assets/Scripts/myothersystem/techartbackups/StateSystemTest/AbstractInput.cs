...
//{
    public class AbstractInput : MonoBehaviour
    {
        ...
        //[SerializeField] private bool isJogging;
            ...
            //EVENTS
        public delegate void MoveInputEvent(string id, Vector2 inputValue);
        public event MoveInputEvent OnMoveEvent;

        public delegate void AnalogAimEvent(string id, Vector2 aimvalue);
       ...
       // private PlayerInput m_PlayerInput;
        ...
        {
            OnAimEvent(_uniqueID, value);
        }
        protected void OnMoveInput(Vector2 inputValue)
        {

            OnMoveEvent(_uniqueID, inputValue);
        }
